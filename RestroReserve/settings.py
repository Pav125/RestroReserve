"""
Django settings for RestroReserve project.
...
ALLOWED_HOSTS = ['https://restro-reserve.vercel.app']
...
ROOT_URLCONF = 'RestroReserve.urls'
...
WSGI_APPLICATION = 'RestroReserve.wsgi.application'
